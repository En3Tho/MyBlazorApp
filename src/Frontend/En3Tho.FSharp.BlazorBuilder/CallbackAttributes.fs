...
type CallbackAttributes() =
    ...
    static member onLoadedMetadata' (receiver: obj, value: Action) =
        Attribute<KnownAttributes.OnLoadedMetadata, _>(EventCallback.Factory.Create<EventArgs>(receiver, value))

    static member onLoadedMetadata' (receiver: obj, value: Action<EventArgs>) =
        Attribute<KnownAttributes.OnLoadedMetadata, _>(EventCallback.Factory.Create<EventArgs>(receiver, value))

    static member onLoadedMetadata' (receiver: obj, value: EventCallback) =
        Attribute<KnownAttributes.OnLoadedMetadata, _>(EventCallback.Factory.Create<EventArgs>(receiver, value))

    static member onLoadedMetadata' (receiver: obj, value: EventCallback<EventArgs>) =
        Attribute<KnownAttributes.OnLoadedMetadata, _>(EventCallback.Factory.Create<EventArgs>(receiver, value))

    static member onLoadedMetadata' (receiver: obj, value: Func<Task>) =
        Attribute<KnownAttributes.OnLoadedMetadata, _>(EventCallback.Factory.Create<EventArgs>(receiver, value))

    static member onLoadedMetadata' (receiver: obj, value: Func<EventArgs, Task>) =
        Attribute<KnownAttributes.OnLoadedMetadata, _>(EventCallback.Factory.Create<EventArgs>(receiver, value))
